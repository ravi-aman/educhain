(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/node_modules_46601075._.js", {

"[project]/node_modules/scroll-lock/dist/scroll-lock.js [app-client] (ecmascript)": (function(__turbopack_context__) {
...
"[project]/node_modules/react-just-parallax/dist/esm/index.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
;
const u = "undefined" != typeof performance ? ()=>performance.now() : ()=>Date.now(), c = "undefined" != typeof window ? (e)=>window.requestAnimationFrame(e) : (e)=>setTimeout(()=>e(u()), 16.666666666666668);
let l = !0, a = !1, d = !1;
const h = {
    delta: 0,
    timestamp: 0
    ...
    "render",
    "postRender"
], v = f.reduce((e, t)=>(e[t] = function(e) {
        let t = [], n = [], r = 0, i = !1, s = !1;
        const o = new WeakSet, u = {
            schedule: (e, s = !1, u = !1)=>{
                const c = u && i, l = c ? t : n;
                return s && o.add(e), -1 === l.indexOf(e) && (l.push(e), c && i && (r = t.length)), e;
            },
            cancel: (e)=>{
                const t = n.indexOf(e);
            ...
            process: (c)=>{
                if (i) s = !0;
                    ...
                    if (i = !0, [t, n] = [
                        ...
                        const r = t[n];
                        r(c), o.has(r) && (u.schedule(r), e());
                    }
                    i = !1, s && (s = !1, u.process(c));
                }
            }
        };
        return u;
    }(()=>a = !0), e), {}), p = f.reduce((e, t)=>{
    const n = v[t];
    return e[t] = (e, t = !1, r = !1)=>(a || E(), n.schedule(e, t, r)), e;
}, {}), w = f.reduce((e, t)=>(e[t] = v[t].cancel, e), {});
f.reduce((e, t)=>(e[t] = ()=>v[t].process(h), e), {});
const m = (e)=>v[e].process(h), y = (e)=>{
    a = !1, h.delta = l ? 16.666666666666668 : Math.max(Math.min(e - h.timestamp, 40), 1), h.timestamp = e, d = !0, f.forEach(m), d = !1, a && (l = !1, c(y));
}, E = ()=>{
    a = !0, l = !0, d || c(y);
};
var g = "undefined" != typeof globalThis ? globalThis : "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {}, _ = /^\s+|\s+$/g, x = /^[-+]0x[0-9a-f]+$/i, L = /^0b[01]+$/i, b = /^0o[0-7]+$/i, O = parseInt, T = "object" == typeof g && g && g.Object === Object && g, M = "object" == typeof self && self && self.Object === Object && self, W = T || M || Function("return this")(), z = Object.prototype.toString, U = Math.max, S = Math.min, H = function() {
    return W.Date.now();
};
function R(e) {
    var t = typeof e;
...
function C(e) {
    ...
    e = e.replace(_, "");
    var n = L.test(e);
    return n || b.test(e) ? O(e.slice(2), n ? 2 : 8) : x.test(e) ? NaN : +e;
}
var j = function(e, t, n) {
    var r, i, s, o, u, c, l = 0, a = !1, d = !1, h = !0;
    if ("function" != typeof e) throw new TypeError("Expected a function");
    function f(t) {
        var n = r, s = i;
        return r = i = void 0, l = t, o = e.apply(s, n);
    }
    function v(e) {
        return l = e, u = setTimeout(w, t), a ? f(e) : o;
    }
    function p(e) {
        var n = e - c;
    ...
    function w() {
        ...
        u = setTimeout(w, function(e) {
            var n = t - (e - c);
            return d ? S(n, s - (e - l)) : n;
        }(e));
    }
    function m(e) {
        return u = void 0, h && r ? f(e) : (r = i = void 0, o);
    }
    function y() {
        var e = H(), n = p(e);
        if (r = arguments, i = this, c = e, n) {
            if (void 0 === u) return v(c);
            if (d) return u = setTimeout(w, t), f(c);
        }
        return void 0 === u && (u = setTimeout(w, t)), o;
    }
    return t = C(t) || 0, R(n) && (a = !!n.leading, s = (d = "maxWait" in n) ? U(C(n.maxWait) || 0, t) : s, h = "trailing" in n ? !!n.trailing : h), y.cancel = function() {
        void 0 !== u && clearTimeout(u), l = 0, r = c = i = u = void 0;
    }, y.flush = function() {
        return void 0 === u ? o : m(H());
    }, y;
}, D = {
    exports: {}
}, $ = "undefined" != typeof document ? document.createElement("p").style : {}, k = [
    "O",
    "ms",
    "Moz",
    "Webkit"
...
function Y(e) {
    ...
    for(var t = e.charAt(0).toUpperCase() + e.slice(1), n = k.length; n--;){
        var r = k[n] + t;
...
D.exports = function(e) {
    return e in X ? X[e] : X[e] = Y(e);
}, D.exports.dash = function(e) {
    return e = Y(e), I.test(e) && (e = "-" + e.replace(I, "-$1"), I.lastIndex = 0), e.toLowerCase();
};
const P = {
    isReady: !1,
    scrollbarWidth: 0,
    ...
    const [e, s] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(P), o = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(P), u = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])(()=>{
        const e = {
            isReady: !0,
...
class N extends class {
    ...
    constructor(){
        super(), this._mouseLast = {
            ...
            x: 0,
            y: 0
        }, this._shouldUpdate = !1, this._onTouchDown = (e)=>{
            this._shouldUpdate && (this._isTouching = !0, this._mouseLast.x = "touches" in e ? e.touches[0].clientX : e.clientX, this._mouseLast.y = "touches" in e ? e.touches[0].clientY : e.clientY, this.mouse.x = this._mouseLast.x, this.mouse.y = this._mouseLast.y, this.dispatchEvent({
                type: "down"
            }), this.dispatchEvent({
                type: "mousemove"
            }));
            ...
            const t = "touches" in e ? e.touches[0].clientX : e.clientX, n = "touches" in e ? e.touches[0].clientY : e.clientY, r = t - this._mouseLast.x, i = n - this._mouseLast.y;
            this._mouseLast.x = t, this._mouseLast.y = n, this.mouse.x += r, this.mouse.y += i, this.dispatchEvent({
                type: "mousemove"
            });
        }, this._onTouchUp = ()=>{
    ...
    init(e) {
        this._targetEl = window, e && e.current && (this._targetEl = e.current), this._addEvents();
    }
    destroy() {
        this._removeEvents();
    }
    setShouldUpdate(e) {
        this._shouldUpdate = e;
    }
    update() {
        this._mouseLast.x = this.mouse.x, this._mouseLast.y = this.mouse.y;
    }
}
const V = ()=>"undefined" != typeof window && ("ontouchstart" in window || "ontouchstart" in document.documentElement || navigator.maxTouchPoints > 0), B = {
    height: 1,
    width: 1,
    x: 1,
    y: 1
}, q = (t)=>{
    const { children: r, strength: s = .14, parallaxContainerRef: o = null, scrollContainerRef: u = null, shouldResetPosition: c = !1, enableOnTouchDevice: l = !1, isAbsolutelyPositioned: a = !1, lerpEase: d = .06, zIndex: h = null, shouldPause: f = !0 } = t, { windowSizeRef: v } = A(), m = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null), y = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null), E = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(0), g = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(0), _ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(0), x = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(0), L = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null), b = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null), O = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(!0), T = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(B), M = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(new N), W = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null), z = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(D.exports("transform")), U = ()=>{
        O.current && m.current && (m.current.style.willChange = "transform", L.current = p.render(H, !0), b.current = p.update(R, !0));
    }, S = ()=>{
        m.current && (m.current.style.willChange = "auto", L.current && w.render(L.current), b.current && w.update(b.current));
    }, H = ()=>{
        if (!m.current) return;
        let e = v.current.windowWidth, t = v.current.windowHeight;
        o && o.current && (e = T.current.width, t = T.current.height), e *= .5, t *= .5, e *= s, t *= s, m.current.style[z.current] = `translate3d(${E.current * e}px, ${g.current * t}px, 0px)`;
    }, R = ({ delta: e })=>{
        const t = Math.abs(_.current - E.current), n = Math.abs(x.current - g.current);
        if (t < .001 && n < .001) return;
        let r = e / 16.666666666666668;
        M.current.update();
        const i = Math.round(r);
        i >= 1 && (r = i);
        const s = F(E.current, _.current, d * r);
        E.current = s;
        const o = F(g.current, x.current, d * r);
        g.current = o;
    }, C = ()=>{
        document.hidden ? S() : U();
    }, $ = (e, t)=>{
        let n = v.current.windowWidth, r = v.current.windowHeight, i = e, s = t;
        return o && o.current && (n = T.current.width, r = T.current.height, i = e - T.current.x, s = t - T.current.y), {
            x: i / n * 2 - 1,
            y: s / r * 2 - 1
        };
    }, k = (e)=>{
        const t = e.target.mouse.x, n = e.target.mouse.y, { x: r, y: i } = $(t, n);
        _.current = r, x.current = i;
    }, I = ()=>{
        c && (_.current = 0, x.current = 0);
    }, X = (e)=>{
        const t = "touches" in e ? e.touches[0].clientX : e.clientX, n = "touches" in e ? e.touches[0].clientY : e.clientY, { x: r, y: i } = $(t, n);
        (r <= -1 || r >= 1 || i >= 1 || i <= -1) && I();
    }, Y = ()=>{
        ...
        if (e[0].isIntersecting) O.current = !0, U(), M.current.setShouldUpdate(!0);
        else {
            if (!f) return;
            O.current = !1, S(), M.current.setShouldUpdate(!1);
        }
    };
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        if (!l && V()) return;
        M.current.init(o), U();
        let e = window, t = window;
        return u && u.current && (t = u.current), o && o.current && (Y(), e = o.current, t.addEventListener("scroll", P, {
            passive: !0
        }), window.addEventListener("resize", P, {
            passive: !0
        })), M.current.addEventListener("mousemove", k), window.addEventListener("visibilitychange", C), window.addEventListener("touchstart", X, {
            passive: !0
        }), e.addEventListener("mouseout", I), W.current = new IntersectionObserver(q, {
            threshold: .5
        }), y.current && W.current.observe(y.current), ()=>{
            S(), o && o.current && (t.removeEventListener("scroll", P), window.removeEventListener("resize", P)), M.current.removeEventListener("mousemove", k), window.removeEventListener("visibilitychange", C), window.removeEventListener("touchstart", X), e.removeEventListener("mouseout", I), y.current && W.current && W.current.unobserve(y.current), M.current.destroy();
        };
    ...
    yMaxOffset: 1,
    yOffset: 1
}, G = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["forwardRef"])((t, r)=>{
    ...
    const { children: s, strength: u = .14, scrollContainerRef: c = null, enableOnTouchDevice: l = !0, lerpEase: a = .06, isHorizontal: d = !1, isAbsolutelyPositioned: h = !1, zIndex: f = null, shouldPause: v = !0 } = t, m = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null), y = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null), E = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(1), g = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(1), _ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(1), x = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(1), L = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null), b = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null), O = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(!0), T = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(Z), M = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(1), W = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(1), { windowSizeRef: z } = A(), U = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(D.exports("transform")), S = ()=>{
        ...
        if (!m.current) return;
        let e = d ? 1 : 0;
        m.current.style[U.current] = `translate3d(${E.current * u * e}px, ${g.current * u * (1 - e)}px, 0px)`;
    }, C = ({ delta: e })=>{
        if (!O.current) return;
        const t = Math.abs(_.current - E.current), n = Math.abs(x.current - g.current);
        if (t < .001 && n < .001) return;
        ...
        const i = Math.round(r);
        i >= 1 && (r = i);
        const s = F(E.current, _.current, a * r);
        E.current = s;
        const o = F(g.current, x.current, a * r);
        g.current = o;
    }, $ = ()=>{
        document.hidden ? H() : S();
    }, k = ()=>{
        (()=>{
            ...
            M.current = T.current.xOffset + e.x + .5 * e.width, W.current = T.current.yOffset + e.y + .5 * e.height;
        })(), Y();
    }, I = j(k, 150), X = ()=>{
        var e;
        c && c.current ? T.current = {
            xOffset: (e = c.current).scrollLeft,
            yOffset: e.scrollTop,
        ...
        X();
        let e = T.current.xOffset - M.current, t = T.current.yOffset - W.current;
        if (e += .5 * z.current.windowWidth, t += .5 * z.current.windowHeight, _.current = e, x.current = t, Math.abs(x.current) > 1.5 * z.current.windowHeight || Math.abs(_.current) > 1.5 * z.current.windowWidth) {
            if (!v) return;
            O.current = !1;
        } else O.current = !0;
    };
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        S();
        let e = window;
        return c && c.current && (e = c.current), e.addEventListener("scroll", Y, {
            passive: !0
        }), window.addEventListener("visibilitychange", $), window.addEventListener("resize", I), k(), ()=>{
            H(), e.removeEventListener("scroll", Y), window.removeEventListener("visibilitychange", $), window.removeEventListener("resize", I);
        };
    }, []), __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].createElement(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].Fragment, null, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].createElement("span", {
        ref: y,
        style: {
...
//# sourceMappingURL=node_modules_46601075._.js.map